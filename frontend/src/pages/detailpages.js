...
function Detailsproduct() {
    ...
    const Addbutton = () => {
        ...
        return  <button class="btn btn-dark mt-2" onClick={() => {
    ...
    <div className="bghaft">
        ...
        <div className="container mt-5">       
            ...
            <div className="row">
                ...
                <div className="col-lg-8 col-sm-12 flexend" data-aos="fade-up" data-aos-delay="300">
                    <div className="row flexbetween">
                    <div className="mt-2 ml-3">Description : {dataProduct?.product?.productDesc}</div> <button class="btn btn-danger mt-2 mr-3" >Delete</button>
                    </div>
                    <h2 className="textbold">Price : {dataProduct?.product?.price} USD</h2>
                    <h4 className="textbold">Stock : {dataProduct?.product?.hasStock?.quantity}</h4>
                    <input type="number" class="form-control bg-light col-6" min="0" max='9999' value={quantity} onChange={(e) => setQuantity(e.target.value)} placeholder="Quantity of product" required/> 
                    <Addbutton/>
                </div>
            </div>
        </div>
