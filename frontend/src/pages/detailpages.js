...
function Detailsproduct() {
  ...
  const [getCart, { loading, data: datacart }] = useLazyQuery(FIND_CART_QUERY, {
  ...
  return (
    <div className="bghaft">
      ...
      <div className="container mt-5">
        <h2 className="textbold" data-aos="fade-up" data-aos-delay="100">
          ...
          >
            <div className="row flexbetween">
              <div className="mt-2 ml-3">
                Description : {dataProduct?.product?.productDesc}
              </div>{" "}
              <button class="btn btn-danger mt-2 mr-3">Delete</button>
            </div>
