...
function EditPromotion() {
  ...
  } = useQuery(FIND_PROMOTION_ONE, { variables: { promotionId: name.string } });
  const [
    QueryProduct,
        ...
        <div className="row">
          <div className="row col-12">
            <div className="col-lg-12 mt-2">
              ...
              <h5 className="mr-5">
                Promotion detail percentage and name pf promotion
              </h5>
              <hr />
            </div>
            ...
            <div className="col-lg-12 mt-2">
              ...
              <div className="col-6 mt-4">
                <div
                  ...
                  style={{
                    backgroundImage:
                      "url(" + productSelect?.product?.imgUrl + ")",
                  }}
                >
                  <div
                    className="filterbg"
                    style={{
                      boxShadow:
                        dataProduct?.product?._id === selected
                          ? "0px 0px 0px 10px #5cb85cE0"
                          : "",
                      transition: "0.25s",
                    }}
