    ...
    <div className="loginpages row">
        <div className="boxlogin"  data-aos="zoom-out"> 
            ...
            <div className="inputbox col-12">
                <input type="text" class="form-control mt-2 col input" placeholder="Username" onChange={handleUsernameChange}/>
                <input type="password" class="form-control mt-2 col input" placeholder="Password" onChange={handlePasswordChange}/>
                <input type="text" class="form-control mt-2 col input" placeholder="Name" onChange={handleNameChange}/>
            </div>
            <br/>
            <div className="buttonbox col-12">
                <button class="btn btn-dark col-12 mt-2 buttonlog" type="button" onClick={handleRegister}>register</button>
                <button class="btn btn-light col-12 buttonlog mt-2" type="button" onClick={redirectToLogin}>go to login</button>
            </div>
        </div>
    </div>
    </>
