...
function Dashboard() {
    ...
    const { data:order ,loadingorder } = useQuery(FIND_LATEST_ORDER,{fetchPolicy: "network-only"})
            ...
            return (
                <div class="col-lg-4 col-xs-4 mb-3 ">
                        ...
                        <div class="card-footer text-dark flexbe ">
                            <h4 className="boldhead mb-0 totaltext mt-2 ml-1">Quantity : {item?.hasStock?.quantity} </h4>
  ...
  return (
    ...
    <div className="bg">
        ...
        <div className="container">
            ...
            <div className="col-lg-6 col-xs-12">
                    <div className="row bg-light boxorderdashboard mt-2">
                        <div className="col-12">
                        ...
                        <div className="row col-lg-12 ml-1">        
                            ...
                            <h5 class="card-title textbold text-light mt-2">Order : {order?.orders[0]?._id}</h5>
                            </div>
                            <hr className="bg-light"/>            
                            <h5 className="text-light">Total: {order?.orders[0]?.totalPrice} USD</h5>
                             </div>
                ...
                <div className="col-lg-12 col-xs-12">
                    ...
                    <div className="col-12">
                            <h3 className="ml-1 textbold">Quantity of Product</h3>
                            <hr/>
                        </div>
                        <div className="row col-lg-12 col-xs-12mr-0 pr-0">
                            <div className="row ml-0 mr-0 pr-0 pl-0">
                            <Rendershoe/>
                                </div>
